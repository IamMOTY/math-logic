...
data Token = TArrow | TNot | TAnd | TOr | TOpBr | TClBr | TTurn | TCommo | TVar String | Bottom deriving (Eq, Show)

alex_action_1 =  \s -> TTurn  
alex_action_2 =  \s -> TArrow 
alex_action_3 =  \s -> TNot   
alex_action_4 =  \s -> TAnd   
alex_action_5 =  \s -> TOr    
alex_action_6 =  \s -> TOpBr  
alex_action_7 =  \s -> TClBr  
alex_action_8 =  \s -> TCommo 
