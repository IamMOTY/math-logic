...
happyExpList = Happy_Data_Array.listArray (0,40) ([12800,51200,8192,16387,2,4,0,800,0,12800,0,36864,0,0,50,200,1024,0,12800,0,0,0,1,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseProof","%start_parseExpr","Expr","Disj","Conj","Unary","\"->\"","'!'","'&'","'|'","var","'('","')'","\"|-\"","','","%eof"]
...
action_4 (11) = happyShift action_16
...
action_19 (11) = happyShift action_16
